  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="/resources/views/User/home.blade.php"><h2>EZGI  <em>ORGANIZATION</em></h2></a>
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="inner-content">
              <p>Copyright &copy; 2022 EZGI ORGANIZATION Co., Ltd.
